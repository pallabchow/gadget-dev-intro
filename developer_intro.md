...
The supported messages and their JSON formats are documented in the file [README.md](./README.md). Here we will describe how gadgets use these messages to communicate with the player.
